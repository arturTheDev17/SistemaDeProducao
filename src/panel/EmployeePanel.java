...
public class EmployeePanel implements Observer {
    ...
    private void screen() {
        ...
        LOG_ERRORS_LIST.setModel(getLogData());
        ...
        labelCountMachinesWithProblems.setBounds(50, 80, labelCountMachinesWithProblems.getPreferredSize().width, labelCountMachinesWithProblems.getPreferredSize().height);
        labelAmountOfProblems.setBounds(50, 120, labelAmountOfProblems.getPreferredSize().width, labelAmountOfProblems.getPreferredSize().height);
     ...
     */
    private DefaultListModel getLogData() {
