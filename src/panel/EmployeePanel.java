...
public class EmployeePanel implements Observer {
    ...
    private void screen() {
        ...
        OPERATORS_LOG_ERRORS.setModel(getLogData("DataWelder"));
        ...
        MANAGERS_LOG_ERRORS.setModel(getLogData("DataLathe"));
        ...
        panelOperators.add(scrollPaneWelder);
        ...
        panelManager.add(scrollPaneLathe);
    ...
    private void updateDataScreen() {
        ...
        OPERATORS_LOG_ERRORS.setModel(getLogData("Manager"));
    }
